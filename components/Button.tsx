...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    outline: "border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-indigo-500 dark:border-white/15 dark:bg-white/5 dark:text-slate-200 dark:hover:bg-white/10",
    ghost: "text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-slate-300 dark:hover:bg-white/5 dark:hover:text-white",
  };
