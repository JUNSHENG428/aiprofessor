...
export const FlashcardsPanel: React.FC<FlashcardsPanelProps> = ({
  ...
  return (
    <div className="w-96 bg-white/85 dark:bg-slate-900/80 backdrop-blur-xl border-l border-gray-200/70 dark:border-white/10 flex flex-col h-full shadow-xl shadow-black/20 flex-shrink-0">
      {/* Header */}
